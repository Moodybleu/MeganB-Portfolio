...
const Contact = (props) => {
  return (
    <div className="contact-container">
      <Helmet>
        <title>Contact - Megan Benn Portfolio</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Contact - Megan Benn Portfolio" />
        <meta
      ...
      <div className="contact-container5">
        ...
        <a
          href="https://www.linkedin.com/in/megan-benn/LinkedIn Profile"
          target="_blank"
          rel="noreferrer noopener"
          className="contact-link1"
        >
          <span>www.linkedin.com/in/megan-benn/</span>
          <br></br>
      ...
      <div className="contact-container6">
        ...
        <a
          href="mailto:Meganbenn27@icloud.com?subject=Viewed Your Portfolio"
          className="contact-link2"
        >
          Meganbenn27@icloud.com
        </a>
      </div>
    </div>
  )
