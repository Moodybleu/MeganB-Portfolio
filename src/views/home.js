...
import NavigationLinks2 from '../components/navigation-links'
import './home.css'
...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Megan Benn Portfolio</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Megan Benn Portfolio" />
        <meta
      ...
      <header data-role="Header" className="home-header">
        <div className="home-nav">
          <div data-thq="thq-dropdown" className="home-thq-dropdown list-item">
            ...
            >
              <span className="home-text">Navigation</span>
              <div
            ...
            <ul data-thq="thq-dropdown-list" className="home-dropdown-list">
              ...
              <li data-thq="thq-dropdown" className="home-dropdown1 list-item">
                ...
                >
                  <Link to="/past-project" className="home-navlink1">
                    Past Projects
                  </Link>
                </div>
              </li>
              <li data-thq="thq-dropdown" className="home-dropdown2 list-item">
                ...
                >
                  <Link to="/current-projects" className="home-navlink2">
                    Current Projects
                  </Link>
                </div>
              </li>
              <li data-thq="thq-dropdown" className="home-dropdown3 list-item">
                ...
                >
                  <Link to="/contact" className="home-navlink3">
                    <span className="home-text1">Contact</span>
                    <br></br>
                  </Link>
                </div>
              </li>
        ...
        <div className="home-icon-group">
          <a
            href="https://www.linkedin.com/in/megan-benn/"
            target="_blank"
          ...
          <a
            href="https://github.com/Moodybleu"
            target="_blank"
            rel="noreferrer noopener"
          >
      ...
      <h1 className="home-text3">
        <span className="home-text4">Megan Benn</span>
